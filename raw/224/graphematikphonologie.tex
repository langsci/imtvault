...
Im Wort \textit{Bussen} [bʊṣən] ist der Vokal der Erstsilbe kurz, die Silbe aber dank Silbengelenk geschlossen und damit zweimorig.
...
\begin{exe}
  ...
  \ex{\label{ex:dehnungsundschaerfungsschreibungen018} /făz/ (\textit{Fass}) \phopro
  \begin{xlist}
  ...
  \begin{xlist}
    \ex[ ]{\label{ex:dehnungsundschaerfungsschreibungen022} [bʊṣən]}
