...
\shorttitlerunninghead{MWEs and the Emotion Lexicon}
...
We hereby present work aimed at treating \is{multiword expression!verbal} verbal multi-word predicates
...
have been studied (\citealt{leeman1991,gross1995locale,balibar1995,tutin2006})  from a different point of view. Finally, a comparative analysis of English and \ili{French}
...
in Table \ref{fig:03:01}; the table comprises verbal MWEs\is{multiword expression!verbal} with the underlying
...
for \ili{Greek} (\citeauthor{fotopoulou1993} \citeyear*{fotopoulou1993}; \citealt{Mini2009}) and \ili{French} \citep{gross1982}. The selection of the \ili{Greek} MWEs was performed as a two-stage
...
\textit{Vsent} \lnexlat{φοβάμαι}{fovame}{to be frightened}:
...
} -- \lnexlat{είμαι έκπληκτος}{ime ekpliktos}{to be surprised}:
...
emotion MWEs in \ili{Greek} and \ili{French} were consolidated and \is{cross-linguistic parallelism} cross-lingual analogies
...
\lnexl{έχω}{eχo}/\textit{avoir }‘to have’,
\lnexl{είμαι Prep}{ime Prep}/\textit{être Prep }‘be Prep’, 
\lnexl{κάνω}{kano}/\textit{faire }‘to make’,
the operator verb 
\lnexl{δίνω}{δino}/\textit{donner }‘to give’,
%\textit{,} 
and the causative verbs 
\lnexl{προκαλώ}{prokalo}/\textit{défier, provoquer }‘to cause’, 
\lnexl{προξενώ}{prokseno}/ \textit{pro\-vo\-quer }‘to cause’, 
\lnexl{αφήνω}{afino}/\textit{laisser }‘to leave’, which
...
\lnexlat{νιώθω}{nioθo}{to feel} or
\lnexlat{αισθάνομαι}{esθanome}{to feel} (see (\ref{ex:3:8})); similarly,
...
implicitly encoded in the \is{Lexicon-Grammar} LG tables. In this respect, naming
...
this class is of the form \textit{N0 V Prep C1}. In  (\ref{ex:3:18}), the \ili{Greek} MWE consists of the verb 
\lnexlat{κάθομαι}{kaθome}{to sit}
and the lexicalised \textit{PP} 
\lnexlat{στα καρφιά}{sta karfia}{on the nails}.
...
\lnexl{μεγάλος}{meγalos}/\textit{grand} ‘big’, 
\lnexl{λίγος}{liγos}/\textit{petit} ‘few’,
\lnexl{φοβερός}{foveros}/\textit{intense }‘awful’,
\lnexl{άκρατος}{akratos}/\textit{in-tense }‘awful’, etc.:
...
\is{alternation!causative-inchoative} causative-inchoative alternation is a syntactic property that involves
...
\is{alternation!transitive-intransitive}transitive-intransitive
...
The semantic classification of the studied \ili{Greek} and \ili{French} MWEs  was aimed at
...
\lnexl{έχω}{eχo}/\textit{avoir} ‘to have’,
\lnexl{νιώθω}{nioθo}/\textit{éprouver} ‘feel’ and 
\lnexl{αισθάνομαι}{esθanome}/\textit{ressentir} ‘to
...
\lnexlat{πετάω}{petao}{fly} and \textit{rayonner}
...
\lnexl{έχω}{eχo}/\textit{avoir} ‘to have’,
\lnexl{νιώθω}{nioθo}/\textit{éprouver} ‘to feel’ and
\lnexl{αισθάνομαι}{esθanome}/\textit{resentir} ‘to feel’.} 
adhere to a
...
\lnexl{ανατριχιάζω}{anatriχiazo}/\textit{frissoner} ‘to shiver’, \lnexl{λάμπω}{labo}/\textit{briller} ‘to shine’,
\lnexl{λιώνω}{liono}/\textit{fondre} ‘to dissolve’, etc.} In this case, the \textit{Vsup}
...
be more productive than its \ili{Greek} counterpart 
\lnexlat{πλέω}{pleo}{to sail} as
...
beneficiary of the event expressed by the predicate (\citealt{leclere1976,fotop1993genitif}). This genitive (in \ili{Greek}) and PP (in \ili{French}) is a specific
