...
du français}
\shorttitlerunninghead{Comment le créole réanalyse les dérivations
du français}
...
UMR7114,~Université Paris Nanterre}% Bâtiment A - Bureau A 402~; 200,
%avenue de la République 92001 Nanterre Cedex~-~ France~\href{mailto:Florence.Villoing@u-paris10.fr}{Florence.Villoing@u-paris10.fr}}
\and
Maxime Deglas \affiliation{Structures Formelles du Langage~ (SFL), CNRS~:
UMR7023,~Université Paris VIII - Vincennes Saint-Denis}%, Bâtiment D salle
%324, 2 rue de la Liberté 93526 Saint-Denis~-~ France
%\href{mailto:maximedeglas@yahoo.fr}{\nolinkurl{maximedeglas@yahoo.fr}}}
}

% \chapterDOI{} %will be filled in at production
%\epigram{Change epigram in chapters/01.tex or remove it there }
 \abstract{
Le présent article présente les conditions d'apparition de deux schémas morpho\-lo\-giques en créole guadeloupéen, la suffixation verbale dénominale en \emph{--\emph{é}} (N-\emph{é}\textsubscript{V}) (ex : \emph{biké} `se réfugier' ← \emph{bik} `refuge' ; \emph{miganné} `mélanger ← \emph{migan} `purée') et la parasynthèse verbale dénominale (\emph{dé}--N-\emph{é}\textsubscript{V}) (ex : \emph{déchèpiyé} `mettre en charpie' ← \emph{chépi} `charpie', \emph{dépyété} `retirer les pattes (crabes)' ← \emph{pyèt} `pattes'). Nous montrons que ces shémas ont émergé via la réanalyse de paires morphologiques Verbe / Nom, massivement héritées du français, langue lexificatrice, issues soit de conversions (\emph{bròs} `brosse' / \emph{brosé} `brosser') soit de préfixations (\emph{bwa} `bois' / \emph{débwazé} `déboiser'). L'article défend l'hypothèse que c'est notamment la spécificité des lexèmes créoles de n'apparaître que sous une forme unique qui a conduit à ces réanalyses : les verbes créoles ne variant pas flexionnellement, la finale flexionnelle française /e/ héritée est réanalysée comme suffixe dérivationnel, suivant ainsi un processus de déflexionnalisation propre au changement linguistique. }
...
\begin{table}
  ...
  \lsptoprule
  Groupe & Finale & Finale & Issus de & Issus de  & Issus de formes\\
en  & créole & en  & formes & participes  & d'indicatif/\\
français &  &  français & d'infinitifs & passés & impératif présent & glose\\
  \midrule
...
hérité, verbe construit en créole, verbe autre), nous obtenons les
proportions suivantes (cf. Tableau~\ref{tab:VilloingDeglas:3} qui ne représente que les trois
...
Verbes à
  ...
  & \multicolumn{2}{c}{Verbes hérités}
...
finale en & & & & & \multicolumn{2}{c}{ en créole} & & \\
  ...
  \lspbottomrule
  \end{tabular}}
  \caption{Proportion de verbes hérités, construits ou autres selon
  leur finale.}
...
\ea \label{ex:VilloingDeglas:35b}
      \ea[*]{\gll bòdé\textsubscript{V} \textrightarrow{} débòé\textsubscript{V}\\
        {} {} {`déborder'}\\}
      \ex[*]{\gll friché\textsubscript{V} \textrightarrow{} défriché\textsubscript{V}\\
        {} {} {`défricher'}\\}
      \ex[*]{\gll krasé\textsubscript{V} \textrightarrow{} dékrasé\textsubscript{V}\\
        {} {} {`décrasser'}\\}
      \ex[*]{\gll mayoté\textsubscript{V} \textrightarrow{} démayoté\textsubscript{V}\\
        {} {} {`démailloter'}\\}
      \ex[*]{\gll rasiné\textsubscript{V} \textrightarrow{} dérasiné\textsubscript{V}\\
        {} {}  {`déraciner'}\\}
      \z
\ex \label{ex:VilloingDeglas:35c}
      \ea[*]{\gll débòd\textsubscript{N} \textrightarrow{} débòdé\textsubscript{V}\\
        {} {} {`déborder'}\\}
      \ex[*]{\gll défrich\textsubscript{N} \textrightarrow{} défriché\textsubscript{V}\\
        {} {} {`défricher'}\\}
      \ex[*]{\gll dékras\textsubscript{N} \textrightarrow{} dékrasé\textsubscript{V}\\
        {} {} {`décrasser'}\\}
      \ex[*]{\gll démayo\textsubscript{N} \textrightarrow{} démayoté\textsubscript{V}\\
        {} {} {`démailloter'}\\}
      \ex[*]{\gll dérasin\textsubscript{N} \textrightarrow{} dérasiné\textsubscript{V}\\
      {} {}   {`déraciner'}\\}
\z\z
...
\ea \label{ex:VilloingDeglas:37}
      ...
      \ex[*]{\gll tiké \textrightarrow{} {détiké (*tiké~; *détik)}\\
        {} {}   {`retirer les tiques' }\\}
...
\ex \label{ex:VilloingDeglas:38}
      ...
      {} {}    {`retirer la main de bananes du régime.'}\\}
      \ex[*]{\gll détik \textrightarrow{} {détiké (*tiké~; *détik)}\\
      {} {}    {`retirer les tiques'}\\}
